...
public class AreaAdapter2 extends BaseAdapter implements Filterable {
    ArrayList<Areas> areas;
    ArrayList<Areas> areas_all;
    Context context;
    LayoutInflater inflater;
    PlanetFilter planetFilter;
    FirstTimeAreaSelectionActivity homeActivity;
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if (constraint == null || constraint.length() == 0) {
                ...
                while (it.hasNext()) {
                    ...
                    if (Pattern.compile(Pattern.quote(constraint.toString())).matcher(p.title).find()) {
                        nPlanetList.add(p);
                    }
                }
    ...
    public AreaAdapter2(Context context, FirstTimeAreaSelectionActivity homeActivity, ArrayList<Areas> areas) {
